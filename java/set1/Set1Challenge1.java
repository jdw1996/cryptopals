...
public class Set1Challenge1 {
    ...
    // NB: This function is only defined for the sake of the challenge. It is
    //   preferable to interface with Data objects where possible.
    public static void String hexToBase64(String x) {
